...
<%
    ...
    <div class="detail-movie" style="position: absolute; top: 30%; left: 0; display: flex; flex-wrap: wrap; width: 100%;">
       <div class="popular-slider">
    	<div class="popular-slider-card" style="display: flex; flex-wrap: wrap; margin-bottom: 2rem; padding-top: 30px !important;">
    	<%int i=0; %>
       	<% for(Movie m : movie_dao.getListMovieLastest()) { 
       	%>
            <div class="popular-slider-card-item" style="margin-bottom: 2rem; transition: width 0.5s !important;">
