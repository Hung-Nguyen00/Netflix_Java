...
<%
    ...
    <div class="My-List-label">
        <h1>Search for <span style="color: red;"> <%=movie_name %></span></h1>
    </div>

    <div class="detail-movie" style="position: absolute; top: 28%; left: 0; display: flex; flex-wrap: wrap; width: 100%;">
       <div class="popular-slider">
    	<div class="popular-slider-card" style="display: flex; flex-wrap: wrap; margin-bottom: 2rem; padding-top: 30px;">
    	<%int i=0; %>
       	...
       	%>
            <div class="popular-slider-card-item" style="margin-bottom: 2rem;">
                ...
                <div class="popular-slider-card-item--hover" style="max-width: 300px !important;">
