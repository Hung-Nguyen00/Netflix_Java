...
<head>
    ...
    <link rel="stylesheet" href="${root}/Inner-Website/lib/css/login.css" />
    ...
    <script src="${root}/Inner-Website/lib/js/login.js"></script>
                ...
                <div class="login-box">
                    ...
                    <div class="sign-up">
                        ...
                        <%if(request.getParameter("emailPar") != null){ %>
                            <input type="email" class="form-control bg-dark text-light w-100" name="email" id="input-username" aria-describedby="help-username" value="<%=request.getParameter("emailPar")%>" 
                            onfocus="showElement('usernameTip')" 
                            onblur="hideElement('usernameTip')" />
                            <%}else{ %>
                            <input type="email" class="form-control bg-dark text-light w-100" name="email" id="input-username" aria-describedby="help-username" 
                            onfocus="showElement('usernameTip')" 
                            onblur="hideElement('usernameTip')" />
                            <%} %>
